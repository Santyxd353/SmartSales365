    ...
    <section className="container-edge py-10">
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.25 }} className="max-w-md mx-auto card p-6">
        ...
        <form onSubmit={onSubmit} className="space-y-3">
          ...
          <button disabled={loading} className="btn btn-primary w-full"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4"><path d="M12 12a5 5 0 1 0 0-10 5 5 0 0 0 0 10Z"/><path d="M3 22a9 9 0 1 1 18 0v1H3v-1Z"/></svg> {loading ? 'Creando…' : 'Crear cuenta'}</button>
        </form>
