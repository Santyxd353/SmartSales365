    ...
    <section className="container-edge mt-4">
      <div className="relative card overflow-hidden">
        ...
        <motion.div
          ...
          className="absolute inset-0 bg-gradient-to-r from-black/40 to-transparent flex items-center"
        >
          <div className="p-6 sm:p-10">
            ...
            <p className="text-white/90 mt-2 max-w-xl">
              Ofertas en electrodomésticos, audio y consolas. Calidad y garantía.
            </p>
          </div>
        </motion.div>
      </div>
